      ...
      <div className="container">
        ...
        <div className="mt-12 grid grid-cols-3 gap-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-9">
          {brands.map((b) => (
            <div 
              key={b} 
              className="flex h-16 items-center justify-center rounded-xl border border-primary bg-primary text-black font-semibold text-sm transition-smooth hover:bg-orange-600 hover:border-orange-600"
            >
              {b}
            </div>
          ))}
